...
def take_gum_out():
    ...
    if response == "1":
        ...
        if random.choice([True, False]):
            ...
            display("Instead, you choose to style your hair so the gum can't be seen and you'll figure out your next steps after you're finished working for the day.")
            game_ending_successful2()
        else: 
            display("You have no idea what you're doing and you cut more hair than you needed to cut.")
            display("You keep cutting to try and even out your uneven snips.")
            display("Before you know it, you have cut so much that you are at a point of no return.")
            display("You look like a crazy person and there's no way you're leaving the house again until you get a wig or salon appointment.")
...
def game_ending_unsuccessful():
    display("You call your job and tell them you will not be able to make the meeting.")
    display("A team member jumps in and handles the meeting beautifully.")
    display("Your boss realizes they don't actually need you and you get fired.")
    display("Some stories have nice endings, but not this. Better luck next time!")

def game_ending_successful2():
    display("With the gum crisis temporarily averted, you quickly finish getting ready and head to your office for the meeting.")
    display("As you enter the office, you find your colleagues gathered in the conference room.")
    display("The meeting starts, and you impress everyone with your fabulousness, preparedness, and brilliant ideas.")
    display("You did a superb job at hiding the gum stuck in your hair and no one even noticed!")
    display("Congratulations! You successfully navigated the gum-in-hair emergency and aced your meeting!")
    display("This hairventure may be over for now, but who knows what a different day may bring!")
